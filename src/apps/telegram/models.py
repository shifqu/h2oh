...
class TelegramSettings(AbstractTelegramSettings):
    ...
    daily_goal_ml = models.IntegerField(
        ...
        help_text=_(
            ...
            "The bot will help you reach this amount before the end of your reminder window."
        ),
    )
    reminder_window_start = models.TimeField(
        verbose_name=_("first reminder"),
        default=time.fromisoformat("08:00"),
        help_text=_("The time of day when your reminders should begin."),
    )
    ...
    consumption_size_ml = models.IntegerField(
        ...
        help_text=_(
            ...
            "The bot uses this to plan how many reminders you need each day."
        ),
    ...
    default_postpone_seconds = models.IntegerField(
        ...
        help_text=_("How long a reminder should be postponed when you choose “Remind me later” (in seconds)."),
    )
    ...
    reminder_text = models.CharField(
        ...
        help_text=_("The message you want the bot to send you for each reminder."),
    )
    ...
    def compute_next_reminder_datetime(self, from_time=None):
        """Compute the next reminder datetime."""
        if from_time is None:
            from_time = timezone.now()
        return self.hydration_schedule.compute_next_reminder_datetime(from_time)
