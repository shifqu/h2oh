...
class Command(TelegramCommand):
    ...
    description = "Log water consumption for the user."
...
class AskConsumptionSize(TelegramStep):
    ...
    def handle(self, telegram_update: TelegramUpdate):
        ...
        prompt = "Please provide your consumption size (ml) or click the button to use the default."
        if "_error" in data:
        ...
        keyboard = [[{"text": "Use default", "callback_data": default_callback}]]
...
class LogConsumption(TelegramStep):
    ...
    def handle(self, telegram_update: TelegramUpdate):
        ...
        try:
            ...
            error_message = f"Invalid input for {consumption_size=}: {exc}."
